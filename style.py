...
SHORT_XTICK_MAX_LENGTH = 4
SHORT_YTICK_MAX_LENGTH = 4
...
SINGLE_LINE_STYLE = dict(
    color=DARK_COLOR, linewidth=1, marker='', linestyle='solid')
REFERENCE_LINE_STYLE = dict(
    color=REFERENCE_LIGHT_COLOR,
    # linewidth=0.75,
    marker='',
    linestyle='dashed')
LIGHT_LINE_STYLE = dict(
    color=LIGHT_COLOR, linewidth=1, alpha=0.3, marker='', linestyle='solid')
